...
INSERT INTO "new_ClassSession" ("classType", "clientId", "endsAt", "id", "minRankId", "minRankName", "name", "programId", "startsAt", "styleId", "styleIds", "styleName", "styleNames") SELECT "classType", "clientId", "endsAt", "id", "minRankId", "minRankName", "name", "programId", "startsAt", "styleId", "styleIds", "styleName", "styleNames" FROM "ClassSession";
