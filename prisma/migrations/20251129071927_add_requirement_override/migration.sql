...
INSERT INTO "new_Attendance" ("attendanceDate", "checkedInAt", "classSessionId", "id", "memberId", "source") SELECT "attendanceDate", "checkedInAt", "classSessionId", "id", "memberId", "source" FROM "Attendance";
