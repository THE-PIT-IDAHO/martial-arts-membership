  ...
  return (
    <AppLayout>
      <div className="space-y-6">
        ...
        {/* 2) New Belt Rank (form only, full width, no partition) */}
        <section
          id="belt-rank-editor"
        ...
        >
          ...
          <div className="rounded-md border border-gray-200 bg-gray-50 p-3">
            <form onSubmit={handleSaveRank} className="space-y-3">
              {/* Row 1: Order | Belt Rank Name | Notes (3 columns) */}
                  ...
                  sortedRanks.map((rank, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* Belt Rank Name (inline + popup if overflow) */}
                                ...
                                >
                                  <div className="flex flex-1 items-center gap-1">
                                    ...
                                    <input
                                      ...
                                      onKeyDown={handleInlineKeyDown}
                                      className="w-full min-w-[5rem] max-w-[14rem] cursor-text rounded border border-gray-300 px-1 py-0.5 text-[11px] focus:outline-none focus:ring-1 focus:ring-primary"
                                    />
                                  </div>
