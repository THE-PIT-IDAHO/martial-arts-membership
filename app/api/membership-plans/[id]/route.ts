    ...
    if (updatePlanTemplate) {
      membershipPlan = await prisma.membershipPlan.update({
        ...
        data: {
          ...
          ...(rankPromotionDiscountFlatCents !== undefined && { rankPromotionDiscountFlatCents: rankPromotionDiscountFlatCents ? Number(rankPromotionDiscountFlatCents) : null }),
          ...
          ...(cancellationProcedure !== undefined && { cancellationProcedure: cancellationProcedure?.trim() || null }),
